...
def weight_difference(refined_parameters, non_refined_parameters, intensity, i_calc, stderr, sintheta_ov_lambda, c_mode, n_p, conditions):
    n_i = len(intensity)
...
def refine_weighting(refined_parameters, non_refined_parameters, intensity, i_calc, stderr, sintheta_ov_lambda, c_mode, n_p):
    ...
    x = minimize(weight_fun_jit,
                 ...
                 args=(non_refined_parameters, intensity_pos, i_calc, stderr, sintheta_ov_lambda, c_mode, n_p, conditions),
                 jac=grad_weight_fun)
